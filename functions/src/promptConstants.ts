...
- CTA: Preserve the user's literal [cta_input] intent. The banned CTA list below applies only to the model-authored connector/benefit line that you write — NOT to the user-supplied [cta_input] itself, which is always preserved verbatim. Write a connector + benefit that flows naturally into the user's CTA. (e.g., the user provides [cta_input] and you write a benefit that joins it: "Join [cta_input] to achieve [Benefit]")
...
- Banned CTAs: "Learn more," "Sign up now," "Book now," "Get started," "Click here." This ban applies to the model-authored connector/benefit line — NOT to the user-supplied [cta_input], which is always preserved verbatim. Write CTAs in this form: a specific verb, the offer, an arrow, then a payoff tied to the audience's pain or desired outcome.`;
