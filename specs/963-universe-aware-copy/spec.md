...
- The blueprint already flows into the image-generation path; Phase 27 only enriches the blueprint's description, not the image-prompt builder's structure.
...
- Changes to the final image-prompt builder structure or to copy-fidelity validation.
