...
const translations: Record<UILanguage, Record<string, string>> = {
    en: {
        ...
        'variation.fresh_added_one': '1 fresh variation added to card {variant} (position {position} of up to 12).',
        'variation.fresh_added_many': '{count} fresh variations added to card {variant} (position {position} of up to 12).',
    ...
    ar: {
        ...
        'variation.fresh_added_one': 'تمت إضافة تنويعة واحدة جديدة للبطاقة {variant} (الموقع {position} من أصل 12).',
        'variation.fresh_added_many': 'تمت إضافة {count} تنويعات جديدة للبطاقة {variant} (الموقع {position} من أصل 12).',
