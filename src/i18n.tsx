...
const translations: Record<UILanguage, Record<string, string>> = {
    en: {
        ...
        'team.removedFromTeam': "You've been removed from {ownerName}'s team.",
        ...
        'join.decline_failed': 'Failed to decline invite.',
        ...
        'join.accept_invite': 'Accept Invite',
        'join.decline_invite': 'Decline',
        'join.invite_declined': 'Invite declined.',
        'join.ready_to_join': 'You are ready to join this team.',
        'join.verify_email_prompt': 'A verification email has been sent. Please verify your email, then return to this page.',
        'join.continue_to_app': 'Continue',
        'join.declined': 'Invite declined successfully.',
        ...
        'billing.teamReadOnly': 'Team member — read only',
        'billing.noInfo': 'No billing information available.',
        ...
        'billing.error.planDowngraded': 'This feature requires a higher plan.',
        'billing.error.trialExpired': 'Your trial has ended — upgrade to continue.',
    ...
    ar: {
        ...
        'team.removedFromTeam': 'تمت إزالتك من فريق {ownerName}.',
        ...
        'join.decline_failed': 'فشل رفض الدعوة.',
        ...
        'join.accept_invite': 'قبول الدعوة',
        'join.decline_invite': 'رفض',
        'join.invite_declined': 'تم رفض الدعوة.',
        'join.ready_to_join': 'أنت مستعد للانضمام إلى هذا الفريق.',
        'join.verify_email_prompt': 'تم إرسال بريد إلكتروني للتحقق. يرجى التحقق من بريدك الإلكتروني، ثم العودة إلى هذه الصفحة.',
        'join.continue_to_app': 'متابعة',
        'join.declined': 'تم رفض الدعوة بنجاح.',
        'errors.fields_required': 'جميع الحقول مطلوبة.',
        'errors.email_password_required': 'البريد الإلكتروني وكلمة المرور مطلوبان.',
        'errors.password_min_length': 'كلمة المرور يجب أن تكون 8 أحرف على الأقل.',
        ...
        'billing.teamReadOnly': 'عضو فريق — للقراءة فقط',
        'billing.noInfo': 'لا توجد معلومات فوترة.',
        ...
        'billing.error.planDowngraded': 'هذه الميزة تتطلب خطة أعلى.',
        'billing.error.trialExpired': 'انتهت الفترة التجريبية — قم بالترقية للمتابعة.',
        'billing.error.unknown': 'حدث خطأ. يرجى المحاولة مرة أخرى.',
