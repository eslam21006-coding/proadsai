...
const translations: Record<UILanguage, Record<string, string>> = {
    en: {
        ...
        'meta.picker_current': 'Currently selected',
        'meta.picker_select': 'Select',
        'meta.picker_cancel': 'Cancel',
        ...
        // ── Phase 14 Batch 04 — What's Working Dashboard ──
        'whats_working.title': "What's Working",
        'whats_working.subtitle': 'How your ads are performing',
        'whats_working.menu_label': "What's Working",
        'whats_working.sync.last_just_now': 'Synced just now',
        'whats_working.sync.last_minutes_ago': 'Synced {n} minutes ago',
        ...
        'whats_working.sync.connect_cta': 'Connect Meta',
        'whats_working.summary.spend_label': 'Spend (last 7 days)',
        'whats_working.summary.matched_of_total': '{matched} of {total} matched',
        'whats_working.summary.no_data': 'No data yet',
        'whats_working.angles.title': 'Your Strongest Angles',
        'whats_working.angles.subtitle': 'Sales Campaigns',
        'whats_working.angles.empty': 'Not enough data yet',
        'whats_working.angles.used_count': 'Used {n} times',
        'whats_working.angles.used_with_winners': 'Used {n} times, {w} winners',
        'whats_working.visuals.title': 'Your Strongest Visuals',
        'whats_working.visuals.subtitle': 'Sales Campaigns',
        ...
        'whats_working.link_picker.load_error': 'Could not load your designs. Please try again.',
        'whats_working.link_picker.link_error': 'Could not link this ad. Please try again.',
        'whats_working.unmatched.link_cta': 'Link',
        'whats_working.unmatched.linked_success': 'Ad linked successfully',
        'whats_working.recent.title': 'Recent Verdicts',
        'whats_working.recent.empty': 'No verdicts yet',
        'whats_working.recent.relative_now': 'just now',
        'whats_working.recent.relative_minutes': '{n} minutes ago',
        ...
        'hook_icon.tooltip.good': 'Performs well in your account',
        'hook_icon.tooltip.weak': 'Weak in your account — try {a}',
        'hook_icon.tooltip.weak_two': 'Weak in your account — try {a} or {b}',
    ...
    ar: {
        ...
        'meta.picker_current': 'الحساب المحدد حاليا',
        'meta.picker_select': 'اختيار',
        'meta.picker_cancel': 'إلغاء',
        ...
        // ── Phase 14 Batch 04 — What's Working Dashboard ──
        'whats_working.title': 'ما الذي يعمل',
        'whats_working.subtitle': 'أداء إعلاناتك',
        'whats_working.menu_label': 'ما الذي يعمل',
        'whats_working.sync.last_just_now': 'تمت المزامنة الآن',
        'whats_working.sync.last_minutes_ago': 'تمت المزامنة منذ {n} دقيقة',
        ...
        'whats_working.sync.connect_cta': 'ربط ميتا',
        'whats_working.summary.spend_label': 'الصرف (آخر 7 أيام)',
        'whats_working.summary.matched_of_total': '{matched} من {total} مرتبطة',
        'whats_working.summary.no_data': 'لا توجد بيانات بعد',
        'whats_working.angles.title': 'أقوى زواياك',
        'whats_working.angles.subtitle': 'حملات المبيعات',
        'whats_working.angles.empty': 'لا توجد بيانات كافية بعد',
        'whats_working.angles.used_count': 'استخدمتها {n} مرات',
        'whats_working.angles.used_with_winners': 'استخدمتها {n} مرات، {w} منها ناجحة',
        'whats_working.visuals.title': 'أقوى تصميماتك',
        'whats_working.visuals.subtitle': 'حملات المبيعات',
        ...
        'whats_working.link_picker.load_error': 'تعذّر تحميل تصميماتك. يرجى المحاولة مرة أخرى.',
        'whats_working.link_picker.link_error': 'تعذّر ربط هذا الإعلان. يرجى المحاولة مرة أخرى.',
        'whats_working.unmatched.link_cta': 'ربط',
        'whats_working.unmatched.linked_success': 'تم ربط الإعلان بنجاح',
        'whats_working.recent.title': 'آخر الأحكام',
        'whats_working.recent.empty': 'لا توجد أحكام بعد',
        'whats_working.recent.relative_now': 'الآن',
        'whats_working.recent.relative_minutes': 'منذ {n} دقيقة',
        ...
        'hook_icon.tooltip.good': 'أداء جيد في حسابك',
        'hook_icon.tooltip.weak': 'أداء ضعيف في حسابك — جرّب {a}',
        'hook_icon.tooltip.weak_two': 'أداء ضعيف في حسابك — جرّب {a} أو {b}',
