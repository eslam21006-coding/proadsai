...
const featureRows: FeatureRow[] = [
  { section: 'usage', label: 'Credits / Month', values: ['500', '2,000', '5,000'] },
  { section: 'usage', label: 'Ads / Month', note: '~20 credits per ad', values: ['~25', '~100', '~250'] },
  { section: 'usage', label: 'Saved Projects', values: ['5', '50', 'Unlimited'] },
  { section: 'usage', label: 'Audience Avatars', note: 'Reusable brand profiles that pre-fill the form', values: ['3', '25', 'Unlimited'] },
  ...
  { section: 'engine', label: 'Hook Angles', note: 'Before/after, emotional, pain, curiosity\u2026', values: ['4 core', 'All 11', 'All 11'] },
  { section: 'engine', label: 'Hook Delivery Styles', note: 'Comedic, controversial, question\u2026', values: ['4 core', 'All 12', 'All 12'] },
  { section: 'engine', label: 'Ad Tones', note: 'Formal, bold, mentor, luxury CEO\u2026', values: ['4 tones', 'All 11', 'All 11'] },
  { section: 'engine', label: 'Copywriting Strategies', note: 'Pattern interrupt, myth busting\u2026', values: ['3 core', 'All 8', 'All 8'] },
  { section: 'engine', label: 'Offer Creative Modes', note: 'Value stack, event ticket, book mockup\u2026', values: ['6 basic', 'All 18+', 'All 18+'] },
  ...
  { section: 'studio', label: 'Carousel Ads', values: [false, 'Up to 5 slides', 'Up to 9 slides'] },
  ...
  { section: 'scale', label: 'Batch Rendering', note: 'All hooks \u00d7 concepts \u00d7 sizes in one flow', values: [false, false, { text: '\u2713 Scale only', emphasis: true }] },
  ...
  { section: 'team', label: 'Team Members', note: 'Shared credit pool', values: ['1', '3', '10+'] },
];
